...
export default function RejectButtonModal({ appointment }) {
    ...
    const handleSubmit = (e) => {
        ...
        post(route("shop.appointments.reject", appointment.id), {
            preserveScroll: true,
            data: formData,
        });
    }
            ...
            <AlertDialogContent>
                <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                        This action cannot be undone. This appointment will be permanently rejected.
                    </AlertDialogDescription>
                    <div>
                ...
                <AlertDialogFooter>
                    ...
                    <form onSubmit={handleSubmit}>
                        <Button type="submit" variant="destructive">{processing ? "Rejecting..." : "Confirm"}</Button>
                    </form>
                </AlertDialogFooter>
            </AlertDialogContent>
        </AlertDialog>
