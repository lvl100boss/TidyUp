...
// this is the comment
export default function ShopCarousel2({ shops, title, link }) {
    return (
        <Carousel
            opts={{
                align: "start",
        ...
        >
            <div className="flex items-center justify-between mb-5 ">
                <Link href={link}>
                    <h4 className="text-lg font-medium p-2 border-b border-foreground inline-flex">
                        {title}
                        <ArrowUpRight className="mt-[0.1rem]" />
                    </h4>
                </Link>
